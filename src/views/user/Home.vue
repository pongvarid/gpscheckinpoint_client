...
<div>
    ...
    <v-card>
        ...
        </v-btn>  <h2 class="w3-large w3-text-white">แก้ไขข้อมูลหอพัก</h2>
        </v-card-title>
        <v-card-text>
            <br><br>
            <form @submit.prevent="updateUser()">
              
                     <v-autocomplete outlined   v-model="PROFILE.address2" :items="DORM" color="white" item-text="name" item-value="name" label="หอพัก" placeholder="เลือกหอพัก"></v-autocomplete>
                ...
                if (current) {
                    ...
                    if (sum == -1) {
                        ...
                        if (current.points == 0) {
                            ...
                            if (current.points == 0) {
                                current.points = 0.25
                                this.snackbar = true; await this.updatePoint(current);
                            }
